...
Inputs *volatile Inputs::oneInstance;
...
void Inputs::setPPI(MSXPPI* PPIdevice)
{
  PPI=PPIdevice;
}
...
//
       ...
       if(key<0x150) KeyMatrix[Keys[key][0]]&=~Keys[key][1];
	 }
...
//
  ...
  //copieren naar MSXKeyMatrix
  for (int teller=0;teller<15;teller++){
      PPI->MSXKeyMatrix[teller]=KeyMatrix[teller];
  }
}
