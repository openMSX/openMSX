...
#ifndef GL2RASTERIZER_HH
#define GL2RASTERIZER_HH
...
/** Rasterizer using OpenGL 2.0 features.
  */
class GL2Rasterizer : public Rasterizer, public VideoLayer
{
public:
	// TODO: Make private.
...
private:
	...
	/** The frame that is currently under construction.
	  * TODO: We should have 2/3 of these, rotating like in SDL rasterizer.
	  */
	ColourTexture workScreen;
	...
	LuminanceTexture stripeTexture;
