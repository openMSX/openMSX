...
void LowScaler<Pixel>::scale192(RawFrame& src, SDL_Surface* dst,
                             unsigned startY, unsigned endY, bool /*lower*/)
{
	for (unsigned y = startY; y < endY; ++y) {
		const Pixel* srcLine = src.getPixelPtr(0, y, (Pixel*)0);
...
template <class Pixel>
void LowScaler<Pixel>::scale192(RawFrame& src0, RawFrame& src1, SDL_Surface* dst,
                             unsigned startY, unsigned endY)
{
	for (unsigned y = startY; y < endY; ++y) {
		const Pixel* srcLine0 = src0.getPixelPtr(0, y, (Pixel*)0);
		...
		Pixel* dstLine = Scaler<Pixel>::linePtr(dst, y);
		average(buf0, buf1, dstLine);
	}
}

template <class Pixel>
void LowScaler<Pixel>::scale384(RawFrame& src, SDL_Surface* dst,
                             unsigned startY, unsigned endY, bool /*lower*/)
{
	for (unsigned y = startY; y < endY; ++y) {
		const Pixel* srcLine = src.getPixelPtr(0, y, (Pixel*)0);
...
template <class Pixel>
void LowScaler<Pixel>::scale384(RawFrame& src0, RawFrame& src1, SDL_Surface* dst,
                             unsigned startY, unsigned endY)
{
	for (unsigned y = startY; y < endY; ++y) {
		const Pixel* srcLine0 = src0.getPixelPtr(0, y, (Pixel*)0);
...
template <class Pixel>
void LowScaler<Pixel>::scale768(RawFrame& src, SDL_Surface* dst,
                             unsigned startY, unsigned endY, bool /*lower*/)
{
	for (unsigned y = startY; y < endY; ++y) {
		const Pixel* srcLine = src.getPixelPtr(0, y, (Pixel*)0);
...
template <class Pixel>
void LowScaler<Pixel>::scale768(RawFrame& src0, RawFrame& src1, SDL_Surface* dst,
                             unsigned startY, unsigned endY)
{
	for (unsigned y = startY; y < endY; ++y) {
		const Pixel* srcLine0 = src0.getPixelPtr(0, y, (Pixel*)0);
...
template <class Pixel>
void LowScaler<Pixel>::scale1024(RawFrame& src, SDL_Surface* dst,
                              unsigned startY, unsigned endY, bool /*lower*/)
{
	for (unsigned y = startY; y < endY; ++y) {
		const Pixel* srcLine = src.getPixelPtr(0, y, (Pixel*)0);
...
template <class Pixel>
void LowScaler<Pixel>::scale1024(RawFrame& src0, RawFrame& src1, SDL_Surface* dst,
                              unsigned startY, unsigned endY)
{
	for (unsigned y = startY; y < endY; ++y) {
		const Pixel* srcLine0 = src0.getPixelPtr(0, y, (Pixel*)0);
