...
;   unsigned c2
; Preserved registers: edi, esi, ebp, ebx
SimpleScaler_blur1on1_4_MMX PROC C uses edi esi ebx pIn:NEAR PTR, pOut:NEAR PTR, srcWidth:DWORD, c1:DWORD, c2:DWORD
...
mainloop:
    ...
    emms
    ret
SimpleScaler_blur1on1_4_MMX ENDP
