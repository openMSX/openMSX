...
private:
	...
	static void bit_0_xix(S& s);
	static void bit_1_xix(S& s);
	static void bit_2_xix(S& s);
	static void bit_3_xix(S& s);
	static void bit_4_xix(S& s);
	static void bit_5_xix(S& s);
	static void bit_6_xix(S& s);
	static void bit_7_xix(S& s);

	inline void BIT_IY(byte bit);
	static void bit_0_xiy(S& s);
	static void bit_1_xiy(S& s);
	static void bit_2_xiy(S& s);
	static void bit_3_xiy(S& s);
	static void bit_4_xiy(S& s);
	static void bit_5_xiy(S& s);
	...
	static void res_0_xix(S& s);
	static void res_1_xix(S& s);
	static void res_2_xix(S& s);
	static void res_3_xix(S& s);
	static void res_4_xix(S& s);
	static void res_5_xix(S& s);
	static void res_6_xix(S& s);
	static void res_7_xix(S& s);
	static void res_0_xiy(S& s);
	static void res_1_xiy(S& s);
	static void res_2_xiy(S& s);
	static void res_3_xiy(S& s);
	static void res_4_xiy(S& s);
	static void res_5_xiy(S& s);
	static void res_6_xiy(S& s);
	static void res_7_xiy(S& s);
	static void res_0_xix_a(S& s);
	static void res_0_xix_b(S& s);
	static void res_0_xix_c(S& s);
	static void res_0_xix_d(S& s);
	static void res_0_xix_e(S& s);
	static void res_0_xix_h(S& s);
	static void res_0_xix_l(S& s);
	static void res_1_xix_a(S& s);
	static void res_1_xix_b(S& s);
	static void res_1_xix_c(S& s);
	static void res_1_xix_d(S& s);
	static void res_1_xix_e(S& s);
	static void res_1_xix_h(S& s);
	static void res_1_xix_l(S& s);
	static void res_2_xix_a(S& s);
	static void res_2_xix_b(S& s);
	static void res_2_xix_c(S& s);
	static void res_2_xix_d(S& s);
	static void res_2_xix_e(S& s);
	static void res_2_xix_h(S& s);
	static void res_2_xix_l(S& s);
	static void res_3_xix_a(S& s);
	static void res_3_xix_b(S& s);
	static void res_3_xix_c(S& s);
	static void res_3_xix_d(S& s);
	static void res_3_xix_e(S& s);
	static void res_3_xix_h(S& s);
	static void res_3_xix_l(S& s);
	static void res_4_xix_a(S& s);
	static void res_4_xix_b(S& s);
	static void res_4_xix_c(S& s);
	static void res_4_xix_d(S& s);
	static void res_4_xix_e(S& s);
	static void res_4_xix_h(S& s);
	static void res_4_xix_l(S& s);
	static void res_5_xix_a(S& s);
	static void res_5_xix_b(S& s);
	static void res_5_xix_c(S& s);
	static void res_5_xix_d(S& s);
	static void res_5_xix_e(S& s);
	static void res_5_xix_h(S& s);
	static void res_5_xix_l(S& s);
	static void res_6_xix_a(S& s);
	static void res_6_xix_b(S& s);
	static void res_6_xix_c(S& s);
	static void res_6_xix_d(S& s);
	static void res_6_xix_e(S& s);
	static void res_6_xix_h(S& s);
	static void res_6_xix_l(S& s);
	static void res_7_xix_a(S& s);
	static void res_7_xix_b(S& s);
	static void res_7_xix_c(S& s);
	static void res_7_xix_d(S& s);
	static void res_7_xix_e(S& s);
	static void res_7_xix_h(S& s);
	static void res_7_xix_l(S& s);
	static void res_0_xiy_a(S& s);
	static void res_0_xiy_b(S& s);
	static void res_0_xiy_c(S& s);
	static void res_0_xiy_d(S& s);
	static void res_0_xiy_e(S& s);
	static void res_0_xiy_h(S& s);
	static void res_0_xiy_l(S& s);
	static void res_1_xiy_a(S& s);
	static void res_1_xiy_b(S& s);
	static void res_1_xiy_c(S& s);
	static void res_1_xiy_d(S& s);
	static void res_1_xiy_e(S& s);
	static void res_1_xiy_h(S& s);
	static void res_1_xiy_l(S& s);
	static void res_2_xiy_a(S& s);
	static void res_2_xiy_b(S& s);
	static void res_2_xiy_c(S& s);
	static void res_2_xiy_d(S& s);
	static void res_2_xiy_e(S& s);
	static void res_2_xiy_h(S& s);
	static void res_2_xiy_l(S& s);
	static void res_3_xiy_a(S& s);
	static void res_3_xiy_b(S& s);
	static void res_3_xiy_c(S& s);
	static void res_3_xiy_d(S& s);
	static void res_3_xiy_e(S& s);
	static void res_3_xiy_h(S& s);
	static void res_3_xiy_l(S& s);
	static void res_4_xiy_a(S& s);
	static void res_4_xiy_b(S& s);
	static void res_4_xiy_c(S& s);
	static void res_4_xiy_d(S& s);
	static void res_4_xiy_e(S& s);
	static void res_4_xiy_h(S& s);
	static void res_4_xiy_l(S& s);
	static void res_5_xiy_a(S& s);
	static void res_5_xiy_b(S& s);
	static void res_5_xiy_c(S& s);
	static void res_5_xiy_d(S& s);
	static void res_5_xiy_e(S& s);
	static void res_5_xiy_h(S& s);
	static void res_5_xiy_l(S& s);
	static void res_6_xiy_a(S& s);
	static void res_6_xiy_b(S& s);
	static void res_6_xiy_c(S& s);
	static void res_6_xiy_d(S& s);
	static void res_6_xiy_e(S& s);
	static void res_6_xiy_h(S& s);
	static void res_6_xiy_l(S& s);
	static void res_7_xiy_a(S& s);
	static void res_7_xiy_b(S& s);
	static void res_7_xiy_c(S& s);
	static void res_7_xiy_d(S& s);
	static void res_7_xiy_e(S& s);
	...
	static void set_0_xix(S& s);
	static void set_1_xix(S& s);
	static void set_2_xix(S& s);
	static void set_3_xix(S& s);
	static void set_4_xix(S& s);
	static void set_5_xix(S& s);
	static void set_6_xix(S& s);
	static void set_7_xix(S& s);
	static void set_0_xiy(S& s);
	static void set_1_xiy(S& s);
	static void set_2_xiy(S& s);
	static void set_3_xiy(S& s);
	static void set_4_xiy(S& s);
	static void set_5_xiy(S& s);
	static void set_6_xiy(S& s);
	static void set_7_xiy(S& s);
	static void set_0_xix_a(S& s);
	static void set_0_xix_b(S& s);
	static void set_0_xix_c(S& s);
	static void set_0_xix_d(S& s);
	static void set_0_xix_e(S& s);
	static void set_0_xix_h(S& s);
	static void set_0_xix_l(S& s);
	static void set_1_xix_a(S& s);
	static void set_1_xix_b(S& s);
	static void set_1_xix_c(S& s);
	static void set_1_xix_d(S& s);
	static void set_1_xix_e(S& s);
	static void set_1_xix_h(S& s);
	static void set_1_xix_l(S& s);
	static void set_2_xix_a(S& s);
	static void set_2_xix_b(S& s);
	static void set_2_xix_c(S& s);
	static void set_2_xix_d(S& s);
	static void set_2_xix_e(S& s);
	static void set_2_xix_h(S& s);
	static void set_2_xix_l(S& s);
	static void set_3_xix_a(S& s);
	static void set_3_xix_b(S& s);
	static void set_3_xix_c(S& s);
	static void set_3_xix_d(S& s);
	static void set_3_xix_e(S& s);
	static void set_3_xix_h(S& s);
	static void set_3_xix_l(S& s);
	static void set_4_xix_a(S& s);
	static void set_4_xix_b(S& s);
	static void set_4_xix_c(S& s);
	static void set_4_xix_d(S& s);
	static void set_4_xix_e(S& s);
	static void set_4_xix_h(S& s);
	static void set_4_xix_l(S& s);
	static void set_5_xix_a(S& s);
	static void set_5_xix_b(S& s);
	static void set_5_xix_c(S& s);
	static void set_5_xix_d(S& s);
	static void set_5_xix_e(S& s);
	static void set_5_xix_h(S& s);
	static void set_5_xix_l(S& s);
	static void set_6_xix_a(S& s);
	static void set_6_xix_b(S& s);
	static void set_6_xix_c(S& s);
	static void set_6_xix_d(S& s);
	static void set_6_xix_e(S& s);
	static void set_6_xix_h(S& s);
	static void set_6_xix_l(S& s);
	static void set_7_xix_a(S& s);
	static void set_7_xix_b(S& s);
	static void set_7_xix_c(S& s);
	static void set_7_xix_d(S& s);
	static void set_7_xix_e(S& s);
	static void set_7_xix_h(S& s);
	static void set_7_xix_l(S& s);
	static void set_0_xiy_a(S& s);
	static void set_0_xiy_b(S& s);
	static void set_0_xiy_c(S& s);
	static void set_0_xiy_d(S& s);
	static void set_0_xiy_e(S& s);
	static void set_0_xiy_h(S& s);
	static void set_0_xiy_l(S& s);
	static void set_1_xiy_a(S& s);
	static void set_1_xiy_b(S& s);
	static void set_1_xiy_c(S& s);
	static void set_1_xiy_d(S& s);
	static void set_1_xiy_e(S& s);
	static void set_1_xiy_h(S& s);
	static void set_1_xiy_l(S& s);
	static void set_2_xiy_a(S& s);
	static void set_2_xiy_b(S& s);
	static void set_2_xiy_c(S& s);
	static void set_2_xiy_d(S& s);
	static void set_2_xiy_e(S& s);
	static void set_2_xiy_h(S& s);
	static void set_2_xiy_l(S& s);
	static void set_3_xiy_a(S& s);
	static void set_3_xiy_b(S& s);
	static void set_3_xiy_c(S& s);
	static void set_3_xiy_d(S& s);
	static void set_3_xiy_e(S& s);
	static void set_3_xiy_h(S& s);
	static void set_3_xiy_l(S& s);
	static void set_4_xiy_a(S& s);
	static void set_4_xiy_b(S& s);
	static void set_4_xiy_c(S& s);
	static void set_4_xiy_d(S& s);
	static void set_4_xiy_e(S& s);
	static void set_4_xiy_h(S& s);
	static void set_4_xiy_l(S& s);
	static void set_5_xiy_a(S& s);
	static void set_5_xiy_b(S& s);
	static void set_5_xiy_c(S& s);
	static void set_5_xiy_d(S& s);
	static void set_5_xiy_e(S& s);
	static void set_5_xiy_h(S& s);
	static void set_5_xiy_l(S& s);
	static void set_6_xiy_a(S& s);
	static void set_6_xiy_b(S& s);
	static void set_6_xiy_c(S& s);
	static void set_6_xiy_d(S& s);
	static void set_6_xiy_e(S& s);
	static void set_6_xiy_h(S& s);
	static void set_6_xiy_l(S& s);
	static void set_7_xiy_a(S& s);
	static void set_7_xiy_b(S& s);
	static void set_7_xiy_c(S& s);
	static void set_7_xiy_d(S& s);
	static void set_7_xiy_e(S& s);
	static void set_7_xiy_h(S& s);
	...
	static void rl_xix  (S& s);
	static void rl_xix_a(S& s);
	static void rl_xix_b(S& s);
	static void rl_xix_c(S& s);
	static void rl_xix_d(S& s);
	static void rl_xix_e(S& s);
	static void rl_xix_h(S& s);
	static void rl_xix_l(S& s);
	static void rl_xiy  (S& s);
	static void rl_xiy_a(S& s);
	static void rl_xiy_b(S& s);
	static void rl_xiy_c(S& s);
	static void rl_xiy_d(S& s);
	static void rl_xiy_e(S& s);
	static void rl_xiy_h(S& s);
	...
	static void rlc_xix  (S& s);
	static void rlc_xix_a(S& s);
	static void rlc_xix_b(S& s);
	static void rlc_xix_c(S& s);
	static void rlc_xix_d(S& s);
	static void rlc_xix_e(S& s);
	static void rlc_xix_h(S& s);
	static void rlc_xix_l(S& s);
	static void rlc_xiy  (S& s);
	static void rlc_xiy_a(S& s);
	static void rlc_xiy_b(S& s);
	static void rlc_xiy_c(S& s);
	static void rlc_xiy_d(S& s);
	static void rlc_xiy_e(S& s);
	static void rlc_xiy_h(S& s);
	...
	static void rr_xix  (S& s);
	static void rr_xix_a(S& s);
	static void rr_xix_b(S& s);
	static void rr_xix_c(S& s);
	static void rr_xix_d(S& s);
	static void rr_xix_e(S& s);
	static void rr_xix_h(S& s);
	static void rr_xix_l(S& s);
	static void rr_xiy  (S& s);
	static void rr_xiy_a(S& s);
	static void rr_xiy_b(S& s);
	static void rr_xiy_c(S& s);
	static void rr_xiy_d(S& s);
	static void rr_xiy_e(S& s);
	static void rr_xiy_h(S& s);
	...
	static void rrc_xix  (S& s);
	static void rrc_xix_a(S& s);
	static void rrc_xix_b(S& s);
	static void rrc_xix_c(S& s);
	static void rrc_xix_d(S& s);
	static void rrc_xix_e(S& s);
	static void rrc_xix_h(S& s);
	static void rrc_xix_l(S& s);
	static void rrc_xiy  (S& s);
	static void rrc_xiy_a(S& s);
	static void rrc_xiy_b(S& s);
	static void rrc_xiy_c(S& s);
	static void rrc_xiy_d(S& s);
	static void rrc_xiy_e(S& s);
	static void rrc_xiy_h(S& s);
	...
	static void sla_xix  (S& s);
	static void sla_xix_a(S& s);
	static void sla_xix_b(S& s);
	static void sla_xix_c(S& s);
	static void sla_xix_d(S& s);
	static void sla_xix_e(S& s);
	static void sla_xix_h(S& s);
	static void sla_xix_l(S& s);
	static void sla_xiy  (S& s);
	static void sla_xiy_a(S& s);
	static void sla_xiy_b(S& s);
	static void sla_xiy_c(S& s);
	static void sla_xiy_d(S& s);
	static void sla_xiy_e(S& s);
	static void sla_xiy_h(S& s);
	...
	static void sll_xix  (S& s);
	static void sll_xix_a(S& s);
	static void sll_xix_b(S& s);
	static void sll_xix_c(S& s);
	static void sll_xix_d(S& s);
	static void sll_xix_e(S& s);
	static void sll_xix_h(S& s);
	static void sll_xix_l(S& s);
	static void sll_xiy  (S& s);
	static void sll_xiy_a(S& s);
	static void sll_xiy_b(S& s);
	static void sll_xiy_c(S& s);
	static void sll_xiy_d(S& s);
	static void sll_xiy_e(S& s);
	static void sll_xiy_h(S& s);
	...
	static void sra_xix  (S& s);
	static void sra_xix_a(S& s);
	static void sra_xix_b(S& s);
	static void sra_xix_c(S& s);
	static void sra_xix_d(S& s);
	static void sra_xix_e(S& s);
	static void sra_xix_h(S& s);
	static void sra_xix_l(S& s);
	static void sra_xiy  (S& s);
	static void sra_xiy_a(S& s);
	static void sra_xiy_b(S& s);
	static void sra_xiy_c(S& s);
	static void sra_xiy_d(S& s);
	static void sra_xiy_e(S& s);
	static void sra_xiy_h(S& s);
	...
	static void srl_xix  (S& s);
	static void srl_xix_a(S& s);
	static void srl_xix_b(S& s);
	static void srl_xix_c(S& s);
	static void srl_xix_d(S& s);
	static void srl_xix_e(S& s);
	static void srl_xix_h(S& s);
	static void srl_xix_l(S& s);
	static void srl_xiy  (S& s);
	static void srl_xiy_a(S& s);
	static void srl_xiy_b(S& s);
	static void srl_xiy_c(S& s);
	static void srl_xiy_d(S& s);
	static void srl_xiy_e(S& s);
	static void srl_xiy_h(S& s);
	static void srl_xiy_l(S& s);
