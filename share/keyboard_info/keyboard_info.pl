...
# MSX key names in the keyboard matrix
#------+- bit 7 ---+- bit 6 --------------+- bit 5 -------------+- bit 4 ---+- bit 3 --+- bit 2 -+- bit 1 ---+- bit 0 -+
row  0 | 7         | 6                    | 5                   | 4         | 3        | 2       | 1         | 0       |
row  1 | SEMICOLON | RIGHT_SQUARE_BRACKET | LEFT_SQUARE_BRACKET | BACKSLASH | EQUALS   | MINUS   | 9         | 8       |
row  2 | B         | A                    | DEADKEY1            | SLASH     | PERIOD   | COMMA   | BACKQUOTE | QUOTE   |
