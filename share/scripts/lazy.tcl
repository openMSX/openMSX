...
register_lazy "_cheat.tcl" {findcheat cheat_finder::start cheat_finder::search}
...
register_lazy "_savestate.tcl" {
	savestate loadstate loadstate_dev delete_savestate list_savestates list_savestates_raw}
